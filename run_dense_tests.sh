...
#        ./run_dense_tests.sh --model <model_name> [/path/to/results]
#        ./run_dense_tests.sh --rerun-failed /path/to/results
...
declare -A MODELS=(
    ...
    ["qwen3_5"]="tests/models/qwen3_5/test_modeling_qwen3_5.py"
...
run_test() {
    ...
    # Specifically: test_tp_forward, test_tp_backward, test_tp_generation
